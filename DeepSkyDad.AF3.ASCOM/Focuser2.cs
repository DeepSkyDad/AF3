...
namespace ASCOM.DeepSkyDad.AF3
{
    ...
    /// DSD AF3
    /// </summary>
    [Guid("863c953c-1f1b-47a7-a2ee-f0f2ebacf284")]
    [ClassInterface(ClassInterfaceType.None)]
    public class Focuser2 : FocuserTemplate, IFocuserV2
    {
        private static string driverID = "ASCOM.DeepSkyDad.AF3.Focuser2";
        private static string driverDescription = "ASCOM Deep Sky Dad AF3 (2)";

        public Focuser2() : base(driverID, driverDescription)
        {
        }
