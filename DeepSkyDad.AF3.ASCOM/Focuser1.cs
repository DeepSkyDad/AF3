...
namespace ASCOM.DeepSkyDad.AF3
{
    ...
    public class Focuser1 : FocuserTemplate, IFocuserV2
    {
        private static string driverID = "ASCOM.DeepSkyDad.AF3.Focuser1";
        private static string driverDescription = "ASCOM Deep Sky Dad AF3 (1)";

        public Focuser1() : base(driverID, driverDescription)
        {
        }
